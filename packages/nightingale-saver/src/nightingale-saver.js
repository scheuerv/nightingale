...
class NightingaleSaver extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.fileName = this.getAttribute("file-name") || "nightingale";
  ...
  saveSvg() {
    ...
    element.style.display = "block"; // In order to get the width and height of nightingale manager, its display has to be set to block
